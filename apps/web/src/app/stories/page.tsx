...
export default function TestimoniesPage() {
  ...
  return (
    <div className="bg-rc-bg text-rc-text">
      ...
      {/* Featured Story - Story First, No Overlay */}
        ...
        <>
          ...
          <section className="w-full py-24 md:py-32 px-6 sm:px-8 md:px-12 bg-rc-warm-gray border-t border-rc-border/30">
            ...
            >
              {testimonies[0].videoUrl && (
                <div className="w-full aspect-video rounded-lg overflow-hidden shadow-lg border border-rc-border/40">
                  <iframe
                    width="100%"
                    height="100%"
                    src={testimonies[0].videoUrl}
                    frameBorder="0"
          ...
          {testimonies[0].proof && testimonies[0].proof.length > 0 && (
            <section className="w-full py-24 md:py-32 px-6 sm:px-8 md:px-12 bg-rc-bg border-t border-rc-border/30">
              ...
              >
                <div className="space-y-6">
                  <p className="text-sm font-medium text-rc-text/70 uppercase tracking-wide">Supporting Evidence</p>
