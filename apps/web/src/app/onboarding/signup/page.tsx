...
export default function SignupPage() {
  return (
    <Suspense fallback={<div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#F8F6F2' }}><p style={{ fontSize: '1rem', color: '#666' }}>Loading...</p></div>}>
      <SignupPageContent />
    </Suspense>
  );
}
