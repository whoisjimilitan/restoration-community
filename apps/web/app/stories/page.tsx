...
const mockStories: StoryCard[] = [
  {
    ...
    story: 'Samuel Johnson was a professional internet fraudster. A spiritual force moved through him to deceive, defraud, and destroy through the most advanced online tactics.\n\nHe was not just a local king of internet scamming. He taught hundreds of youngsters these tricks. But one encounter with Jesus changed everything.\n\nThis is proof that deliverance is real.',
    heroImage: {
      url: '/images/testimony.png',
      alt: 'Samuel Johnson - Delivered from Internet Fraud'
    },
      ...
      <section className="w-full min-h-screen flex flex-col justify-center bg-gradient-to-br from-rc-accent to-rc-text px-6 sm:px-8 md:px-12 py-24 md:py-32">
        <div className="max-w-2xl mx-auto w-full space-y-6">
          <div className={`transform transition-all duration-400 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0ms' }}>
            <p className="text-xs font-medium text-white/70 uppercase tracking-wider">My Story. Our Encounter.</p>
          </div>
          ...
          <div className={`transform transition-all duration-400 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '80ms' }}>
            <div className="space-y-3">
              <p className="text-3xl sm:text-4xl md:text-5xl font-rc-serif font-bold text-white leading-tight tracking-tight">Samuel was trapped.</p>
              <p className="text-3xl sm:text-4xl md:text-5xl font-rc-serif font-bold text-white leading-tight tracking-tight">Jesus set him free.</p>
            </div>
          </div>
          ...
          <div className={`transform transition-all duration-400 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '160ms' }}>
            <p className="text-base md:text-lg text-white/90 leading-relaxed font-light">
              Watch what deliverance looks like.
            </p>
          </div>
        </div>
      </section>
        ...
        >
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-base md:text-lg text-white/90 leading-relaxed font-light border-l-2 border-white/30 pl-6">
              <p>Samuel was delivered from fraud.</p>
              <p>I was delivered from fraud.</p>
              <p>You can be delivered too.</p>
            </div>

            <div className="border-t border-white/20 pt-8">
              <div className="space-y-4 text-base md:text-lg text-white/90 leading-relaxed font-light">
                <p>This is not theory. This is not promise. This is proof.</p>
                <p className="pt-2">Jesus Christ delivers people from spiritual bondage.</p>
                <p className="pt-2">You are next.</p>
              </div>
            </div>
          </div>
